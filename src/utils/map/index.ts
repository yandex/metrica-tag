...
const getPolyMap = (): PolyMapConstructor => {
    ...
    const get = toNativeOrFalse(getPath(NativeMap.prototype, 'get')!, 'get');
    const set = toNativeOrFalse(getPath(NativeMap.prototype, 'set')!, 'set');
    const has = toNativeOrFalse(getPath(NativeMap.prototype, 'has')!, 'has');
